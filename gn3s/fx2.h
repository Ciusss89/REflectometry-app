#ifndef HEADER_DF2FC96061E598C0
#define HEADER_DF2FC96061E598C0
...
#include "filesaver.h"
//#include "fx2_config.h"

//#define BUFSIZE 32*512	// 16 kB
#define BUFSIZE 32*512
#define BUFSIZE_AGC 4*512
#define LOOPS 1024
...
public:
    ...
    bool usrp_xfer ( char VRQ_TYPE, char start );
    bool usrp_xfer2 (char VRQ_TYPE, char start, unsigned char *buf, char len );
